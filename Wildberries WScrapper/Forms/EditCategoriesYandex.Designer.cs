...
{
	partial class EditCategoriesYandex
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
            ...
            "Поиск (Старый)",
            "Категория (Новый)"});
			this.comboBox1.Location = new System.Drawing.Point(335, 68);
			this.comboBox1.Name = "comboBox1";
			this.comboBox1.Size = new System.Drawing.Size(555, 26);
			this.comboBox1.TabIndex = 10;
			this.comboBox1.Visible = false;
			this.comboBox1.SelectedIndexChanged += new System.EventHandler(this.comboBox1_SelectedIndexChanged);
			// 
			// EditCategoriesYandex
			// 
			...
			this.Name = "EditCategoriesYandex";
